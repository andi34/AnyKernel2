...
if [ -f ./tuna_kitkat_defconfig-bin/zImage ]; then

	cp -fr ./tuna_kitkat_defconfig-bin/zImage ./
	cp -fr ./tuna_kitkat_defconfig-bin/modules ./
	...
	if [[ ! -z $1 ]]; then
		PACKAGENAME=AnyKernel-$DATE-KitKat-tuna-$1
	else
